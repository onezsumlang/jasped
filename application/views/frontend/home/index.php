...
<section class="py-5">
  <div class="container px-4 px-lg-5 mt-5">
    ...
    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
      ...
      <div class="col mb-5">
        <div class="card h-100">
          <!-- Product image-->
          <img class="card-img-top" src="<?=base_url()?>assets/uploads/services/<?=$row['image1']?>" alt="<?=$row['itemName']?>" />
          <!-- Product details-->
          <div class="card-body p-4">
            <div class="text-center">
              <!-- Product name-->
              <h5 class="fw-bolder"><?=$row['itemName']?></h5>
              <!-- Product reviews-->
    ...
    <?php 
      if(!empty($pertukangan)){
    ?>
    <h4>Pertukangan</h4>
    <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4">
      <?php 
        foreach($pertukangan as $row){
      ?>
      <div class="col mb-5">
        <div class="card h-100">
          <!-- Product image-->
